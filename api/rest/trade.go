...
import (
	...
	requests "github.com/biancheng347/okex/requests/rest/trade"
	responses "github.com/biancheng347/okex/responses/trade"
	"net/http"
)
...
func (c *Trade) PlaceAlgoOrder2(req requests.PlaceAlgoOrder2) (response responses.PlaceAlgoOrder, err error) {
	p := "/api/v5/trade/order-algo"
	m := okex.S2M1(req)
	res, err := c.client.Do(http.MethodPost, p, true, m)
	if err != nil {
